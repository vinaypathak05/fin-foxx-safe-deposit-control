...
const LocaleStrings = new LocalizedStrings({
    en:{
        ...
        agents_detail_wallet_validation_security_amount_required: 'First time agent have to pay more or equal to security deposit money',
        agents_detail_wallet_text_security_money: 'Pay your security money with first recharge',
        ...
        customers_payment_received_form_validation_invalid_amount: 'You can not pay amount less than 1.',
        customers_payment_received_form_validation_invalid_fixed_amount: 'You can not pay amount less than your plan amount.',
        customers_payment_received_form_validation_invalid_agent_amount: 'Agent wallet does not have sufficient amount, recharge agent wallet.',
        customers_payment_received_form_validation_over_amount: 'You can not accept more than customer due amount.',
        customers_payment_received_form_success: 'Customer payment done successfully.!',
        ...
        customers_approve_form_success: 'Agent approval status updated successfully.!',
        ...
        plans_form_validation_plan_duration_min: 'Plan duration should be greated then 1',
        plans_form_validation_plan_price_min: 'Plan price should be greated then 1',
        plans_form_validation_plan_name_exist: 'Plan name is alreay exist, add new plan name.!',
